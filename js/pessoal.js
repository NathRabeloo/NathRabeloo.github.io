document.addEventListener('DOMContentLoaded', function() {
    ...
    function exibirTarefas(tarefas) {
        ...
        tarefas.forEach(tarefa => {
            ...
            row.insertCell(7).innerHTML = `<button style="background-color: green; padding-right:5px;" onclick="editarTarefa(${tarefa.id})">Editar</button> <button style="background-color: red; padding-right:5px;" onclick="excluirTarefa(${tarefa.id})">Excluir</button>`;
        });
    }
